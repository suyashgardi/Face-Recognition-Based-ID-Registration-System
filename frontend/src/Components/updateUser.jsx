...
function UpdateUser() { 
  ...
  const [twoFacto,setTwoFacto]=useState(false);
  ...
  const handleVerificationFailedAuth = () => {
    setIsAuth(false);
  };
  ...
  return (
    <div>
      ...
      {verificationMethod === "face" && !isAuth && (
        <LivenessScanner
          isUpdating={true}
          twoFacto={userdata.T28BitArr}
          uploadedIdFile={userdata.T28BitArr}
          onVerificationSuccess={handlefaceVerification}
          onVerificationFailed={handleVerificationFailedAuth}
        />
      )}
